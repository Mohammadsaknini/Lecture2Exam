...
%    Assign the question pools to their respective writer.
    ...
    \end{tcolorbox}
     ...
     \begin{tcolorbox}[skin=widget,
    	...
    	\begin{itemize}
    		\setlength\itemsep{-0.2em}
    		\item What is model adaption and what is used for? Name at least 2 types of model adaption, explain them and provide an example for each of them.
	...
	\begin{tabularx}{17.5cm}{Y|Y|Y|Y|Y}
		\textbf{Poll} & Human \textcolor{s-group4!80!black}{Group 4}  &  GPT3.5 \textcolor{s-group3!80!red}{Group 3}  & GPT4o \textcolor{s-group2!80!black}{Group 2} & Local \textcolor{s-group1!80!black}{Group 1} \\[5pt]
		\cline{1-5}
		&&&& \\
		"Human" votes & 12 & 4 & 9 & 4 \\
	\end{tabularx}
    \end{tikztable}
}
